...
-- Le prix moyen par personne des chambres avec TV.
...
SELECT num_chambre, num_client FROM reservations WHERE date_arrive = '2019-03-30';
-- Les numéros des chambres coûtant au minimum 80 Euro ayant un bain et valant au maximum 150 Euro.
SELECT num_chambre FROM chambres WHERE confort LIKE 'lit double' AND prix BETWEEN 80 AND 150;
SELECT num_chambre FROM chambres WHERE confort LIKE 'lit double' AND prix >=80 <=150;
